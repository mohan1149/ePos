                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::checkbox('featured', $product->featured, $product->featured == 1 ? true : false) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('stock_item', __('t.stock_item')) }}
                                    {{ Form::checkbox('stock_item', $product->stock_item, $product->stock_item == 1 ? true : false, ['class' => 'product_stock_item']) }}
                                </div>
                            </div>
